...
const Equipments = () => {
    return (
        <main className='relative overflow-hidden pt-11 md:pt-24 overflow-x-hidden'>
            <Head>
                <title>Instruments Used | Electrical Testing and Service Engineers</title>
                <meta name="description" content="Explore the various instruments and equipment used by Electrical Testing and Service Engineers for relay testing, transformer testing, and other electrical services." />
                ...
                <meta property="og:description" content="Explore the various instruments and equipment used by Electrical Testing and Service Engineers for relay testing, transformer testing, and other electrical services." />
                ...
                <meta name="twitter:description" content="Explore the various instruments and equipment used by Electrical Testing and Service Engineers for relay testing, transformer testing, and other electrical services." />
